...
export default Ember.Component.extend(GraphicSupport, MarginConvention, {
  ...
  signedValues: computed('model.{data,series}', function () {
  ...
  layoutValues: computed('signedValues', 'model.{data,series,key}', function () {
    var data = this.get('model.data');
    var series = this.get('model.series');
  ...
  yScale: computed('contentHeight', 'signedValues', function () {
